...
function handleInput() {
  ...
  if (keyIsDown(87)) { player.y -= PLAYER_SPEED; player.direction = "up"; player.isMoving = true; }
  if (keyIsDown(83)) { player.y += PLAYER_SPEED; player.direction = "down"; player.isMoving = true; }
  if (keyIsDown(65)) { player.x -= PLAYER_SPEED; player.direction = "left"; player.isMoving = true; }
  if (keyIsDown(68)) { player.x += PLAYER_SPEED; player.direction = "right"; player.isMoving = true; }
...
if (keyIsDown(32) && player.shootTimer === 0) {
  ...
  let dir = DIR[player.direction];

  bullets.push({
    x: player.x + dir.x * (player.hw + 4),
    y: player.y + dir.y * (player.hh + 4),
